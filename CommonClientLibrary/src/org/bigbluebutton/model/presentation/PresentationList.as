package org.bigbluebutton.model.presentation {
	...
	public class PresentationList {
		...
		public function addAnnotation(annotation:Annotation):void {
			var newAnnotation:Annotation = _currentPresentation.addAnnotation(_currentPresentation.currentSlideNum, annotation);
		...
		public function undoAnnotation():void {
			if (_currentPresentation != null && _currentPresentation.currentSlideNum >= 0) {
				var removedAnnotation:Annotation = _currentPresentation.undoAnnotation(_currentPresentation.currentSlideNum);
