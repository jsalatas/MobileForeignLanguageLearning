...
public class RoleNotification implements java.io.Serializable {
    ...
    public RoleNotification(RoleNotificationId id, Role role, Notification notification) {
	this.id = id;
	this.role = role;
	this.notification = notification;
    }

    public RoleNotification(RoleNotificationId id, Role role, Notification notification, User user, Date dateHandled) {
	this.id = id;
	this.role = role;
	this.notification = notification;
	this.user = user;
